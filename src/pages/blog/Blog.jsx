  ...
  return (
    <div>
      <Pdf targetRef={ref} filename="code-example.pdf">
        {({ toPdf }) => (
          <button
            className="text-center  text-amber-500 font-semibold px-2 py-1 rounded-md ml-20"
            onClick={toPdf}
          >
            Download
          </button>
      ...
      <div ref={ref}>
        ...
        <div className="mx-32 mb-6">
          ...
          <p>
            <span className="text-xl text-amber-700">Ans: </span>
            To validate React props using PropTypes, there are some specific
            steps to follow: <br />{" "}
            <div className="my-2">
              ...
              shape, React will issue a warning in the console to alert you of
              the problem.
            </div>{" "}
            ...
            documentation for other developers who may be using or modifying
            your code.
          </p>
        </div>
        <div className="mx-32 mb-6">
          <h2 className="text-2xl  text-amber-500">
            <span className="text-amber-700 font-bold">c.</span> What is the
            basic difference between nodejs and express js?
          </h2>
          <p>
            <span className="text-xl text-amber-700">Ans:</span>
            Node.js and Express.js are both server-side JavaScript frameworks,
            but there are some key differences between the them:
            <br />
            <div className="my-2">
              ...
              applications and APIs. <br />- Express.js provides a lightweight
              and flexible framework for building web applications, allowing
              developers to choose their own libraries and tools for various
              parts of the application stack. Node.js, on the other hand,
              provides a more low-level platform that requires more manual
              configuration and setup.
            </div>{" "}
            <br />
            In summary, Node.js is a runtime environment for executing
            JavaScript code, while Express.js is a web application framework
        ...
        <div className="mx-32 mb-6">
          <h2 className="text-2xl  text-amber-500">
            <span className="text-amber-700 font-bold">d.</span> What is a
            custom hook, and why will you create a custom hook?
          </h2>
          <p>
            <span className="text-xl text-amber-700">Ans:</span>A custom hook is
            a JavaScript function that uses the React Hooks API to encapsulate
            ...
            <div className="my-2">
              ...
              easier to reuse that code in other parts of your application.{" "}
              <br />
              ...
              have one custom hook that handles state management and another
              that handles API calls, and you can combine them to create a more
              advanced hook that handles both. <br />- Testing: By encapsulating
              logic in a custom hook, you can more easily test that code in
              isolation from your components, improving the overall testability
              of your application.
            </div>
